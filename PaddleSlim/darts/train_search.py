...
def main(args):
    ...
    image_train, label_train, image_val, label_val = build_program(
    ...
    lr = fluid.layers.cosine_decay(args.learning_rate, step_per_epoch,
                                   args.epochs)
    ...
    leader_opt = architect.compute_unrolled_step(image_train, label_train, image_val,
                                    label_val, all_params, model_var, train_loss,
                                    lr, args)
